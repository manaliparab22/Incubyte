...
public class Utility {
	...
	public static void setExtendReport() {
		report = new ExtentReports(System.getProperty("user.dir") + "/reports/GmailExtentReportResults.html");
		report
        .addSystemInfo("Host Name", "Gmail")
        .addSystemInfo("Environment", "Automation Testing")
        .addSystemInfo("User Name", "Manali Parab");
		
		test = report.startTest("Verification of Compose functionality");
	}
